...
const Register=()=>{
    ...
    const [verificationStatus, setVerificationStatus] = useState(false) // false means not verified yet
...
function handleSubmit(e) {
    ...
    return(
       ...
       {
       otpBox ? (<OtpCard validotp={validOtp}/>)
       :null
       } 
        <div className="background w-full h-screen flex flex-row gap-1 font-poppins ">
            ...
            <form onSubmit={handleSubmit} action="" className="flex flex-col gap-3 w-9/12 px-10 py-5 text-[#231f20] text-xl bg-[#f2f4f3] rounded-md shadow-md shadow-[#1f2421]">
                    ...
                    <div className="flex items-center justify-center h-full">
                        <button onClick={()=>{fetchOtp()}} className="px-2 py-1 bg-[#343a40] text-[#f2f4f3] rounded mt-5">Verify</button>
                    </div>
                    </div>
                    <div className="flex flex-col gap-1">
