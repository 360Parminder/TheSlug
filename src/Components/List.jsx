          ...
          >
            ...
            <div className="w-2/12 hidden md:flex items-center justify-center">
              <img
                ...
                // src={
                //   "https://zurl-api.onrender.com/public/assets/url_qrs/" +
                //   value.url_qr
                // }
                alt="Qr code"
              />
                ...
                >
                  <div className="w-full md:w-4/12 flex flex-row items-center justify-center me-3">
                    <a
                      ref={linkRef}
                      href={
                        'https://zurl-api.onrender.com/' + value.shortURL
                      }
                      target="_blank"
                      style={{
                        whiteSpace: 'nowrap',
                      ...
                      className=" ms-1" rel="noreferrer"
                    >
                      {'https://zurl.com/' + value.shortURL}
                    </a>
                    <button
                      onClick={copyToClipboard}
                      className="ms-2  bg-[rgba(28, 40, 63, 0.69)] p-1 rounded-full "
                  ...
                  <div className="w-2/12 hidden md:flex flex-row items-center">
                    <img
                      className="w-10 h-10 rounded-md"
                      src={
                        'https://zurl-api.onrender.com/public/assets/url_logos/' +
                        value.url_logo
                      }
                      alt="logo"
                    />
